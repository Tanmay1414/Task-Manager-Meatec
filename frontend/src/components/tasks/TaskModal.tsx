    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-screen items-center justify-center p-4">
                ...
                <div className="relative transform overflow-hidden rounded-2xl modal-surface shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-xl">
                    <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-indigo-500 to-purple-600"></div>

                    <div className="modal-surface px-6 pb-6 pt-8 sm:px-8">
