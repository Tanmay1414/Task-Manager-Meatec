            ...
            <div className="min-h-screen transition-colors duration-300">
                <div className="max-w-7xl mx-auto py-8 px-6 sm:px-8 lg:px-10">
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-10">
                        <div className="theme-surface rounded-2xl shadow-lg p-6 card-hover">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm font-medium theme-text-muted mb-1">All Tasks</p>
                        ...
                        <div className="theme-surface rounded-2xl shadow-lg p-6 card-hover">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm font-medium theme-text-muted mb-1">In Progress</p>
                        ...
                        <div className="theme-surface rounded-2xl shadow-lg p-6 card-hover">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm font-medium theme-text-muted mb-1">Done</p>
                    ...
                    <div className="theme-surface rounded-2xl shadow-lg p-6">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                            <h2 className="text-2xl font-bold theme-text">Task Overview</h2>
                            <button
